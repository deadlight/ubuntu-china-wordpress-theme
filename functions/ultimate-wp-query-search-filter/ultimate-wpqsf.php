...
include_once content_url('themes/resource-centre/functions/ultimate-wp-query-search-filter/classes/uwpqsf-base-class.php');
include_once content_url('admin/list-from-class.php');	
include_once content_url('themes/resource-centre/functions/ultimate-wp-query-search-filter/classes/uwpqsf-front-class.php');
include_once content_url('themes/resource-centre/functions/ultimate-wp-query-search-filter/classes/uwpqsf-process-class.php');
class ulitmatewpsf{
  ...
  function admin_uwpqsf_js(){
	...
	wp_enqueue_script('js', content_url('themes/resource-centre/functions/ultimate-wp-query-search-filter/admin/scripts/uadmin_awqsfjs.js', __FILE__), array('jquery'), '1.0', true);
	wp_localize_script( 'ajax-request', 'MyAjax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) ); 
  }	

  function admin_uwpqsf_css(){
	wp_enqueue_style('uwpqsfcss', content_url('themes/resource-centre/functions/ultimate-wp-query-search-filter/admin/scripts/admin_uwpqsf.css', __FILE__), '1.0', true);
  }
